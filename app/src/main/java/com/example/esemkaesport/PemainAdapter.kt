...
class PemainAdapter(val listPemain: MutableList<TimModel>, val context: Context): RecyclerView.Adapter<PemainAdapter.PemainAdapterView>() {
    ...
    private fun UpdateUI(holder: PemainAdapterView, tim: TimModel) = runBlocking {
